                ...
                <div class="option-inner">
                    <div class="others-option justify-content-center d-flex align-items-center">
                        ...
                        <div class="shapping-bag">
                            ...
                            <div class="shapping-text" id="cart-notification" style="display: none;">0</div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-6" data-cue="slideInUp">
                    <div class="single-shop-cart">
                        <div class="shop-img">
                            ...
                            <div class="shop-btn">
                                <button type="submit" class="default-btn" onclick="addToCart()">Add To Cart</button>
                            </div>
                        </div>
                        <div class="shop-cart">
                            <a href="shop-details.html">
...
@section('scripts')
    ...
    <script>
        function addToCart() {
            // Logika bisnis untuk menambahkan produk ke keranjang belanja
            // ...

            // Mendapatkan elemen notifikasi keranjang belanja
            var cartNotification = document.getElementById('cart-notification');

            // Mendapatkan jumlah item dalam keranjang belanja
            var cartItemCount = parseInt(cartNotification.textContent);

            // Menambahkan 1 ke jumlah item dalam keranjang belanja
            cartItemCount += 1;

            // Memperbarui tampilan notifikasi keranjang belanja
            cartNotification.textContent = cartItemCount.toString();
