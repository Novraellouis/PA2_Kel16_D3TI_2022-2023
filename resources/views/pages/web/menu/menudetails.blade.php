                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="contact-tab" data-bs-toggle="tab"
                                    ...
                                    style="margin-left: 30px">Reviews</button>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="contact-tab-pane" role="tabpanel"
                                ...
                                <div class="blog-details-from">
                                    @foreach ($review as $item)
                                        @if (isset($item->checkout->id_product))
                                            @if ($item->checkout->id_product == $menu->id)
                                                <div class="single-comment">
                                                    <div class="single-shop-details-contant">
                                                        <h3>{{ $item->checkout->order->user->name }}</h3>
                                                        <span> {{ $item->updated_at->diffForHumans() }}
                                                        </span>
                                                        <p>
                                                            {{ $item->description }}
                                                        </p>
