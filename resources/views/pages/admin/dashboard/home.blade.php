							...
							<div class="card-body revenue-chart px-3">
									<div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
										<div class="d-flex align-items-end mr-4">
											<img src="{{ asset('assets-admin/images/svg/ic_stat2.svg') }}" height="22" width="22" class="mr-2 mb-1" alt=""/>
											<div>
										...
										<div class="d-flex align-items-end">
											<img src="{{ asset('assets-admin/images/svg/ic_stat1.svg') }}" height="22" width="22" class="mr-2 mb-1" alt=""/>
											<div>
