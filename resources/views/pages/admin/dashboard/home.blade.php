        ...
        <div class="container-fluid">
            <div class="form-head d-flex mb-3 align-items-start">
                <div class="mr-auto d-none d-lg-block">
                    ...
                    <p class="mb-0">Welcome to Namura Admin!</p>
                </div>
{{--
                        ...
                        <div class="card-body p-4">
                            <div class="media ai-icon">
                                ...
                                <div class="media-body">
                                    <h3 class="mb-0 text-black"><span class="counter ml-0">{{ $totalMenu }}</span></h3>
                    ...
                    <div class="widget-stat card">
                        <div class="card-body p-4">
                            <div class="media ai-icon">
                                ...
                                <div class="media-body">
                                    <h6 class="mb-0 text-black"><b>Rp.
                                            {{ number_format($totalAmount) }}</b></h6>
                    ...
                    <div class="widget-stat card">
                        <div class="card-body p-4">
                            <div class="media ai-icon">
                                ...
                                <div class="media-body">
                                    <h3 class="mb-0 text-black"><span class="counter ml-0">{{ $totalOrder }}</span></h3>
                    ...
                    <div class="widget-stat card">
                        <div class="card-body p-4">
                            <div class="media ai-icon">
                                ...
                                <div class="media-body">
                                    <h3 class="mb-0 text-black"><span class="counter ml-0">{{ $totalUser }}</span></h3>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div style="margin:20px;">
                            <h2 class="text-center">Grafik Reservasi</h2>
                            <div id="chart"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body revenue-chart px-3">
                            <div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
                                <div class="d-flex align-items-end mr-4">
                                    <img src="{{ asset('assets-admin/images/svg/ic_stat2.svg') }}" height="22"
                                        width="22" class="mr-2 mb-1" alt="" />
                                    <div>
                                ...
                                <div class="d-flex align-items-end">
                                    <img src="{{ asset('assets-admin/images/svg/ic_stat1.svg') }}" height="22"
                                        width="22" class="mr-2 mb-1" alt="" />
                                    <div>
