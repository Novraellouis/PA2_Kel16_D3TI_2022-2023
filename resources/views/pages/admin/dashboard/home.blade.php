        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div style="margin:20px;">
                            <h2 class="text-center">Grafik Pendapatan</h2>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div style="margin:20px;">
                            <h2 class="text-center">Grafik Produk</h2>
                            <div id="favoriteProductChart">
                            </div>
...
@section('custom_js')
    ...
    <script>
        // Menginisialisasi grafik menggunakan data yang diterima dari controller
        var options = {
            series: [{
        ...
        // Menggambar grafik menggunakan data dan opsi yang telah diinisialisasi
        var chart = new ApexCharts(document.querySelector("#revenueChart"), options);
        chart.render();
    </script>
    <script>
        var salesData = <?php echo json_encode($sortedFavoriteProductData); ?>;

        var products = [];
        var seriesData = [];

        salesData.forEach(function(data) {
            var label = data.product + ' - ' + data.month + ' ' + data.year;
            products.push(label);
            seriesData.push(data.total_sales);
        });
        ...
        var chart = new ApexCharts(document.querySelector("#favoriteProductChart"), options);
        chart.render();
    </script>
@endsection
@endsection
