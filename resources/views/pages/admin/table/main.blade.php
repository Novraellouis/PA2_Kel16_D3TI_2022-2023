            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">List Meja</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                                <div class="py-2">
                                                                    ...
                                                                    <form action="{{ route('table.destroy', $table->id) }}"
                                                                        ...
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus pesan ini?')"
