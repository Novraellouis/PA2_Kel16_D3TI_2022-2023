                                ...
                                <form action="{{ route('menu.update', $menu->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="title" placeholder="Masukkan" value="{{ $menu->title }}">
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="category" class="form-select @error('category') is-invalid @enderror">
                                            ...
                                            <option value="Makanan" {{ $menu->category == 'Makanan' ? 'selected' : '' }}>
                                                Makanan</option>
                                            <option value="Makanan" {{ $menu->category == 'Minuman' ? 'selected' : '' }}>
                                                Minuman</option>
                                        </select>
                                        <br>
                                        @error('category')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            name="price" placeholder="Masukkan" value="{{ $menu->price }}">
                                        @error('price')
                                            <span class="alert-danger">
                                                {{ $message }}
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            name="stock" placeholder="Masukkan" value="{{ $menu->stock }}">
                                        @error('stock')
                                            <span class="alert-danger">
                                                {{ $message }}
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class=" form-control form-text @error('description') is-invalid @enderror">{{ $menu->description }}</textarea>
                                        @error('description')
                                            <span class="alert-danger">
                                                {{ $message }}
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            ...
                                            name="cover" placeholder="Masukkan" value="{{ $menu->cover }}">
                                        @error('cover')
                                            <span class="alert-danger">
                                                {{ $message }}
                                            </span>
